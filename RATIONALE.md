...
* **Emphasis**: **Bold** or **Bold Underline** depending on criticality.
* **Language Specific Tokens**:
    * **Ada**: `keyword.control.ada`, `keyword.other.ada` (**Bold Underline**)
...
* **Emphasis**: Regular or **Bold Underline** for definitions.
* **Language Specific Tokens**:
    * **Python**: `entity.name.function.python`, `storage.type.function.python` (**Bold Underline**)
...
* **Emphasis**: *Italic* or *Italic Underline*.
* **Language Specific Tokens**:
    * **C++**: `variable.other.readwrite.cpp`, `variable.other.local.cpp` (*Italic*)
    * **F#**: `variable.fsharp`, `variable.other.binding.fsharp` (*Italic Underline*)
...
* **Software Application**: Used for classes, types, and structural definitions. Types provide the foundational structure of the data. Underlining emphasizes their role as defined, rigid constructs.
* **Emphasis**: <u>Underline</u>.
* **Language Specific Tokens**:
